            ...
            <div className="navbar bg-transparent backdrop-blur-xl shadow-2xl w-11/12 rounded-2xl">
                <div className="navbar-start">
                    <div className="dropdown bg-white">
                        <div tabIndex={0} role="button" className="btn lg:hidden active:scale-95 hover:scale-105 text-black bg-transparent border-0 transition duration-300 ease-in-out m-2">
